...
export default function PrivacyPolicyModal({Id}) {
  return (
    <dialog id={Id} className="modal sm:hidden">
      <div className="modal-box h-screen max-w-xs p-4">
        ...
        <div>
          <strong className="text-lg text-[#6699cc]">Privacy Policy</strong>
          <div className="mt-4">
            <strong className="text-orange-500">Privacy Policy of Bangladeshi Matrimony</strong>
            <p className="text-sm">
