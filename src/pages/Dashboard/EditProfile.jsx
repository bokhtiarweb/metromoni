        ...
        <div className="w-1/4 bg-gray-100 rounded-lg">
                ...
                <div className="flex flex-col space-y-2">
                  {[
                    ...
                    >
                      ...
                      {tab === 'Partner Preference' ? <a href="/profiledetail/editpartnerpreference">{tab}</a> : tab }
                    </button>
                  ))}
                </div>
              </div>
          ...
          <div>
            <div className="collapse collapse-plus border border-base-300 bg-base-200">
              ...
              />
              <div className="min-h-0 collapse-title p-2 sm:text-xs md:text-sm font-medium">
                <h3 className="text-xl font-semibold mb-4">Enhance Profile</h3>
              </div>
              <div className="collapse-content">
                <div className="flex flex-col space-y-2">
                  {["photo"].map((tab) => (
                    ...
                    <div className="grid grid-cols-1 gap-4">
                      ...
                      <div className="">
                        ...
                        <p className="text-sm">
                          ...
                          but can still view their profile but other members
                          will not be able to see and contact you.
                        </p>
