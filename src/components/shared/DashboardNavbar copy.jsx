  ...
  const navLinks = (
    <>
      <div className="relative group">
        ...
        <div className="absolute top-[45px] left-0 w-[550px] h-auto p-4 bg-base-100 hidden group-hover:block group-hover:bg-base-100">
          <div className="flex">
      ...
      <div className="relative group">
        ...
        <div className="absolute top-[45px] left-0 w-[270px] h-[auto] p-4 bg-base-100 hidden group-hover:block group-hover:bg-base-100">
          <div>
            <IoMdArrowDropup className="absolute -top-6 text-white text-5xl"></IoMdArrowDropup>
            <div>
      ...
      <div className="relative group">
        ...
        {/* Dropdown (Hidden by default, shown on hover) */}
        <div className="absolute top-[45px] left-0 w-[230px] h-auto p-4 bg-base-100 hidden group-hover:block group-hover:bg-base-100">
          <div className="flex">
            <IoMdArrowDropup className="absolute -top-6 text-white text-5xl"></IoMdArrowDropup>
            <div>
              <div>
      ...
      <div className="navbar-end">
        <div className="flex items-center justify-center text-white">
          ...
          <div className="relative group flex">
            ...
            {/* Dropdown (Hidden by default, shown on hover) */}
            <div className="absolute top-[45px] right-0 w-[550px] h-auto p-4 bg-base-100 hidden group-hover:block group-hover:bg-base-100">
